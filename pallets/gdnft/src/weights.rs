...
/// Weights for module_nft using the GD node and recommended hardware.
pub struct GdWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for GdWeight<T> {
	fn create_class() -> Weight {
